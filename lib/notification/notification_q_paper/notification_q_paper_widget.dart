...
import 'notification_q_paper_model.dart';
export 'notification_q_paper_model.dart';

class NotificationQPaperWidget extends StatefulWidget {
  const NotificationQPaperWidget({
    super.key,
  ...
  @override
  State<NotificationQPaperWidget> createState() =>
      _NotificationQPaperWidgetState();
}

class _NotificationQPaperWidgetState extends State<NotificationQPaperWidget> {
  late NotificationQPaperModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationQPaperModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NotificationRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final notificationQPaperNotificationRecord = snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    notificationQPaperNotificationRecord
                                        .classID,
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
