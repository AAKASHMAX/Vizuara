...
import 'class9th_topics_model.dart';
export 'class9th_topics_model.dart';

class Class9thTopicsWidget extends StatefulWidget {
  const Class9thTopicsWidget({
    super.key,
  ...
  @override
  State<Class9thTopicsWidget> createState() => _Class9thTopicsWidgetState();
}

class _Class9thTopicsWidgetState extends State<Class9thTopicsWidget>
    with TickerProviderStateMixin {
  late Class9thTopicsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Class9thTopicsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<Class9thRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final class9thTopicsClass9thRecord = snapshot.data!;
                                                              ...
                                                              children: [
                                                                StreamBuilder<
                                                                  ...
                                                                  stream:
                                                                    ...
                                                                    queryBuilder:
                                                                        (topic9thRecord) =>
                                                                            topic9thRecord.orderBy('TopicID'),
                                                                  )..listen((snapshot) {
                                                                          List<Topic9thRecord>
                                                                              listViewTopic9thRecordList =
                                                                              snapshot;
                                                                          if (_model.listViewPreviousSnapshot1 != null &&
                                                                              !const ListEquality(Topic9thRecordDocumentEquality()).equals(listViewTopic9thRecordList, _model.listViewPreviousSnapshot1)) {
                                                                            () async {}();
                                                                          }
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                          (context,
                                                                              listViewIndex) {
                                                                        final listViewTopic9thRecord =
                                                                            listViewTopic9thRecordList[listViewIndex];
                                                                        return Stack(
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                decoration: BoxDecoration(
                                                                                  color: valueOrDefault<Color>(
                                                                                    listViewTopic9thRecord.topicID == FFAppState().selectionID ? FlutterFlowTheme.of(context).mainColor : FlutterFlowTheme.of(context).alternate,
                                                                                    ...
                                                                                    Stack(
                                                                                      ...
                                                                                      children: [
                                                                                        ClipRRect(
                                                                                          ...
                                                                                          child: Image.network(
                                                                                            listViewTopic9thRecord.thumbnail,
                                                                                            width: 130.0,
                                                                                            height: 100.0,
                                                                                            fit: BoxFit.cover,
                                                                                          ),
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Padding(
                                                                                            ...
                                                                                            child: Text(
                                                                                              listViewTopic9thRecord.topicName,
                                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                    fontFamily: 'Nunito Sans',
                                                                                                    color: valueOrDefault<Color>(
                                                                                                      listViewTopic9thRecord.topicID == FFAppState().selectionID ? FlutterFlowTheme.of(context).secondaryBackground : FlutterFlowTheme.of(context).primaryText,
                                                                                ...
                                                                                onPressed: () async {
                                                                                  FFAppState().videopath = () {
                                                                                    if (FFAppState().Language == 'English') {
                                                                                      return listViewTopic9thRecord.videoPathE;
                                                                                    } else if (FFAppState().Language == 'Hindi') {
                                                                                      return listViewTopic9thRecord.videoPathH;
                                                                                    } else {
                                                                                      return listViewTopic9thRecord.videoPathE;
                                                                                    }
                                                                                  }();
                                                                                  FFAppState().selectionID = listViewTopic9thRecord.topicID;
                                                                                  safeSetState(() {});
                                                                                },
                                                                                text: '',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            context.pushNamed(
                                                                              'Class9th_Quiz',
                                                                              queryParameters: {
                                                                                'class9thref': serializeParam(
                                                                                  class9thTopicsClass9thRecord.reference,
                                                        ...
                                                        queryBuilder:
                                                            (topic9thRecord) =>
                                                              ...
                                                              if (_model.listViewPreviousSnapshot2 !=
                                                                      null &&
                                                                  !const ListEquality(
                                                                          Topic9thRecordDocumentEquality())
                                                                      .equals(
                                                                          listViewTopic9thRecordList,
                                                                          _model
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      color: valueOrDefault<
                                                                          Color>(
                                                                        listViewTopic9thRecord.topicID ==
                                                                              ...
                                                                              Row(
                                                                                ...
                                                                                children: [
                                                                                  Padding(
                                                                                    padding: const EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 0.0, 0.0),
                                                                                    child: Text(
                                                                                      class9thTopicsClass9thRecord.classID,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Nunito Sans',
                                                                                            color: valueOrDefault<Color>(
                                                                                              listViewTopic9thRecord.topicID == FFAppState().selectionID ? FlutterFlowTheme.of(context).secondaryBackground : FlutterFlowTheme.of(context).primaryText,
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  class9thTopicsClass9thRecord.chapterName,
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Nunito Sans',
                                                                                        color: valueOrDefault<Color>(
                                                                                          listViewTopic9thRecord.topicID == FFAppState().selectionID ? FlutterFlowTheme.of(context).secondaryBackground : FlutterFlowTheme.of(context).primaryText,
