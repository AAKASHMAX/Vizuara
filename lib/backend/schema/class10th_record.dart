...
class Class10thRecord extends FirestoreRecord {
  Class10thRecord._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Class10th');

  static Stream<Class10thRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Class10thRecord.fromSnapshot(s));

  static Future<Class10thRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Class10thRecord.fromSnapshot(s));

  static Class10thRecord fromSnapshot(DocumentSnapshot snapshot) =>
      Class10thRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Class10thRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Class10thRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Class10thRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Class10thRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createClass10thRecordData({
  String? chapterName,
  int? chapterNo,
  String? classID,
  int? subjectID,
...
class Class10thRecordDocumentEquality implements Equality<Class10thRecord> {
  const Class10thRecordDocumentEquality();

  @override
  bool equals(Class10thRecord? e1, Class10thRecord? e2) {
  ...
  @override
  int hash(Class10thRecord? e) => const ListEquality().hash([
        e?.chapterName,
        e?.chapterNo,
        e?.classID,
        e?.subjectID,
  ...
  @override
  bool isValidKey(Object? o) => o is Class10thRecord;
}
