...
import 'class10th_model.dart';
export 'class10th_model.dart';

class Class10thWidget extends StatefulWidget {
  const Class10thWidget({super.key});

  @override
  State<Class10thWidget> createState() => _Class10thWidgetState();
}

class _Class10thWidgetState extends State<Class10thWidget>
    with TickerProviderStateMixin {
  late Class10thModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Class10thModel());
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 5.0, 0.0, 0.0),
                                                child: StreamBuilder<
                                                    List<Class10thRecord>>(
                                                  stream: queryClass10thRecord(
                                                    queryBuilder:
                                                        (class10thRecord) =>
                                                            class10thRecord
                                                                .where(
                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            FFAppState()
                                                              ...
                                                              if (FFAppState()
                                                                      .Language ==
                                                                  'English') {
                                                                return listViewClass10thRecord
                                                                    .videoPathE;
                                                              } else if (FFAppState()
                                                                      .Language ==
                                                                  'Hindi') {
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    '${listViewClass10thRecord.sequence.toString()}.${listViewClass10thRecord.chapterName}',
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        StreamBuilder<List<Class10thRecord>>(
                                          stream: queryClass10thRecord(
                                            queryBuilder: (class10thRecord) =>
                                                class10thRecord
                                                    .where(
                                                      'SubjectID',
                                                      isEqualTo: 2,
